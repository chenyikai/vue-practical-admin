...
export = MapboxGlDraw;
export as namespace MapboxGlDraw;
...
declare class MapboxGlDraw implements IControl {
    static modes: MapboxGlDraw.Modes;
    static constants: MapboxGlDraw.Constants;
    static lib: MapboxGlDraw.Lib;

    modes: MapboxGlDraw.DrawModes;

    getDefaultPosition: () => string;

    constructor(options?: MapboxGlDraw.MapboxDrawOptions);
    ...
    getMode(): (MapboxGlDraw.DrawMode & {}) | string;
    ...
    changeMode(mode: Exclude<MapboxGlDraw.DrawMode, "direct_select" | "simple_select" | "draw_line_string">): this;
    changeMode<T extends string>(mode: T & (T extends MapboxGlDraw.DrawMode ? never : T), options?: object): this;
