...
function back() {
    router.go(-1);
    setStore({ name: "isReload", content: 0 });
}
onBeforeMount(() => {
    timer = setInterval(() => {
        const time = new Date();
        ...
        <header ref="headerRef" class="map-page-container-header">
            ...
            <div class="header-box">
                ...
                <div class="right-layout">
                    <div class="admin" @click="back">后台管理</div>
                    <user-info />
                </div>
            </div>
        </header>
